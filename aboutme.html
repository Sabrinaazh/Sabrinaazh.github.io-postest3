...
<body>
    ...
    <div class="konten" id="container">
        <div class="adds">
            <div class="iklan">
                <img src="promo.jpg" alt="iklan" width="40%">
            </div>        
        </div>
        ...
        <div class="merk">
            ...
            <div>
                <img src="produk.jpg" alt="produk" width="70%">
                <p>SCARLET FACE CARE PACK <br> <b>Rp. 228.000,-</b><br>Pramuka</p>
            </div>
        ...
        <div class="profile">
            <img src="Bina.jpg" alt="my picture" width="20%" id="info">
